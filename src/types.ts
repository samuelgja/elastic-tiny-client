...
export interface GetScriptContextContextMethod {
  name: Name
  return_type: string
  params: GetScriptContextContextMethodParameter[]
}

export interface GetScriptContextContextMethodParameter {
  name: Name
  type: string
}
...
export type InlineGet<TDocument = unknown> = InlineGetKeys<TDocument> & { [property: string]: any }
...
export interface AggregationsSignificantLongTermsAggregate
  extends AggregationsMultiBucketAggregateBase<AggregationsSignificantLongTermsBucket> {}
...
export interface AggregationsSignificantStringTermsAggregate
  extends AggregationsMultiBucketAggregateBase<AggregationsSignificantStringTermsBucket> {}
...
export interface MappingBinaryProperty extends MappingDocumentValuesPropertyBase {
  type: 'binary'
}

export interface MappingBooleanProperty extends MappingDocumentValuesPropertyBase {
  boost?: double
...
export interface MappingCompletionProperty extends MappingDocumentValuesPropertyBase {
  analyzer?: string
...
export interface MappingDateNanosProperty extends MappingDocumentValuesPropertyBase {
  boost?: double
  format?: string
...
export interface MappingDateProperty extends MappingDocumentValuesPropertyBase {
  boost?: double
  fielddata?: IndicesNumericFielddata
  format?: string
  ignore_malformed?: boolean
...
export interface MappingDocumentValuesPropertyBase extends MappingCorePropertyBase {
  doc_values?: boolean
}
...
export interface MappingDynamicProperty extends MappingDocumentValuesPropertyBase {
...
export interface MappingGeoPointProperty extends MappingDocumentValuesPropertyBase {
  ignore_malformed?: boolean
...
export interface MappingGeoShapeProperty extends MappingDocumentValuesPropertyBase {
  coerce?: boolean
  ignore_malformed?: boolean
  ignore_z_value?: boolean
...
export interface MappingIpProperty extends MappingDocumentValuesPropertyBase {
  boost?: double
  index?: boolean
  null_value?: string
  ignore_malformed?: boolean
...
export interface MappingKeywordProperty extends MappingDocumentValuesPropertyBase {
  boost?: double
  eager_global_ordinals?: boolean
  index?: boolean
  index_options?: MappingIndexOptions
...
export interface MappingMurmur3HashProperty extends MappingDocumentValuesPropertyBase {
  type: 'murmur3'
}
...
export interface MappingNumberPropertyBase extends MappingDocumentValuesPropertyBase {
  index?: boolean
  ignore_malformed?: boolean
  time_series_metric?: MappingTimeSeriesMetricType
}
...
export interface MappingPointProperty extends MappingDocumentValuesPropertyBase {
  ignore_malformed?: boolean
  ignore_z_value?: boolean
  null_value?: string
  type: 'point'
...
export interface MappingRangePropertyBase extends MappingDocumentValuesPropertyBase {
  boost?: double
  coerce?: boolean
  index?: boolean
}
...
export interface MappingShapeProperty extends MappingDocumentValuesPropertyBase {
  coerce?: boolean
  ignore_malformed?: boolean
  ignore_z_value?: boolean
  orientation?: MappingGeoOrientation
...
export interface MappingTokenCountProperty extends MappingDocumentValuesPropertyBase {
  analyzer?: string
  boost?: double
  index?: boolean
  null_value?: double
...
export interface MappingVersionProperty extends MappingDocumentValuesPropertyBase {
  type: 'version'
}

export interface MappingWildcardProperty extends MappingDocumentValuesPropertyBase {
  type: 'wildcard'
  null_value?: string
}
...
export interface QueryDslPinnedDocument {
  _id: Id
  _index: IndexName
}
...
export type IndicesIndexSettings = IndicesIndexSettingsKeys & { [property: string]: any }
...
export type SecurityRoleTemplateScript =
  | SecurityRoleTemplateInlineScript
  | string
  | QueryDslQueryContainer
  | StoredScriptId
